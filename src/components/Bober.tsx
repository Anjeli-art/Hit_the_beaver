  ...
  return (
    <div style={menu}>
      <div className={s.wrapper}>
        {data > 0 && data !== 110 && data < 100 && (
          <div className={s.playbober}>
        ...
        <div className={s.mouseblock} onClick={clickPast}>
          ...
          >
            <img style={boberimg} src={bober} alt={"bober"} />
          </div>
        </div>
        {data === 0 && (
          <div className={s.znakomstvo}>
            <h1>Поймай говнястого бобра</h1>
            <p>
              Это игра на внимательность.
              <br />
              С каждым уровнем бобер двигается все быстрее.
              <br />
              Тебе дается 5 жизней чтоб обыграть бобра.
              <br />
              Если они сгорят,игра начнется заново.
              <br />
        ...
        {data > 99 && data < 110 && (
          <div className={s.znakomstvo}>
            ...
            <div>
              <p>Игра закончена.Количество жизней {hearts.length}</p>
              <p>Чтобы начать игру заново нажми на бобра.</p>
            </div>
          </div>
        )}
        {data === 110 && (
